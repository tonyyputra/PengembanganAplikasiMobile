...
public class ActivityThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextNamaDepan =
                findViewById(R.id.editTextNamaDepan);
        editTextNamaBelakang =
                findViewById(R.id.editTextNamaBelakang);
        textViewHasil = findViewById(R.id.textViewResult);
        btnShow = findViewById(R.id.btnShow);

        btnShow.setOnClickListener(v -> {
            String firstName =
                    editTextNamaDepan.getText().toString();
            String lastName =
                    editTextNamaBelakang.getText().toString();
        ...
        if (savedInstanceState != null) {
            namaLengkap =
                    savedInstanceState.getString("NAMA_LENGKAP", "");
            textViewHasil.setText(namaLengkap);
        }
    }
